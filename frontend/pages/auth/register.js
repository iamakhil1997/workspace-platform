                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition bg-white"
                            >
